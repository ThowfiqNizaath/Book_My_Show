  ...
  return !loading ? (
    <>
      ...
      <div className="relative flex flex-wrap gap-6 mt-4 max-w-5xl">
          <BlurCirle top="100px" left="-10%" />
          {
            dashboardData.activeShows.map((show,index) => (
              <div key={show._id} className="w-55 rounded-lg overflow-hidden pb-3 bg-primary/10 border border-primary/20 hover:-translate-y-1 transition-all duration-300">
